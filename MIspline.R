############# spline function, you can save below codes in a separate R file, and call it in the main codes by source("MIspline.r")
# Bo Cai and Lianming Wang, Oct. 2009, Sept. 2011
